...
- [ ] Task: Write extensive tests for the Smart Merge algorithm.
- [ ] Task: Conductor - User Manual Verification 'Phase 3: Smart Merge Logic (Updates)' (Protocol in workflow.md)

## Phase 4: UI Implementation
- [ ] Task: Update Custom Section UI for Parents.
    - [ ] Add a toggle/checkbox when editing a Custom Section: "Make Inheritable Template for Sub-Species".
- [ ] Task: Update Custom Section UI for Children.
    - [ ] Render a badge/icon (e.g., `InfoOutlined` or a link icon) next to the section title if `inheritedFromSectionId` is present.
    - [ ] Add a tooltip to the badge: "Inherited from parent. You can edit values here without affecting the master template."
