...
## Phase 3: Middle-Click Integration in Editor Mentions [checkpoint: 7065a78]
- [x] Task: Update the rich text editor's mention extension logic. Modify the click handler to distinguish between left-click (`CTRL+Click`) and middle-click.
